...
{
	private static final Kernel.Logger L = Kernel.getLogger( AsyncTask.class );
	...
	private Result postResult( Result result )
	{
		...
		LooperRouter.sendParcelFirst( carrier );
		return result;
	}
	...
	{
		if ( !isCancelled() )
			LooperRouter.sendParcelFirst( ParcelCarrier.obtain( MESSAGE_POST_PROGRESS, new AsyncTaskResult<>( this, values ) ) );
	}
