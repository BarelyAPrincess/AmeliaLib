...
public class ElegantQueryTable extends ElegantQuery<ElegantQueryTable>
{
	...
	public ElegantQueryTable columnCreate( DatabaseColumnType columnType, String columnName ) throws DatabaseException
	{
	...
	{
		getDriver().tableColumnCreate( getTable(), columnName, DatabaseColumnType.INTEGER, columnLength, null );
		return this;
	}

	public ElegantQueryTable columnCreateInt( String columnName, int columnLength, int columnDef ) throws DatabaseException
	{
		getDriver().tableColumnCreate( getTable(), columnName, DatabaseColumnType.INTEGER, columnLength, columnDef );
		return this;
	}

	public ElegantQueryTable columnCreateText( String columnName ) throws DatabaseException
	{
		getDriver().tableColumnCreate( getTable(), columnName, DatabaseColumnType.TEXT, 0, null );
		return this;
	}

	public ElegantQueryTable columnCreateText( String columnName, String columnDef ) throws DatabaseException
	{
		getDriver().tableColumnCreate( getTable(), columnName, DatabaseColumnType.TEXT, 0, columnDef );
		return this;
	}

	public ElegantQueryTable columnCreateVar( String columnName, int columnLength ) throws DatabaseException
	{
		getDriver().tableColumnCreate( getTable(), columnName, DatabaseColumnType.STRING, columnLength, null );
		return this;
	}

	public ElegantQueryTable columnCreateVar( String columnName, int columnLength, String columnDef ) throws DatabaseException
	{
		getDriver().tableColumnCreate( getTable(), columnName, DatabaseColumnType.STRING, columnLength, columnDef );
		return this;
	}
