...
import io.amelia.database.drivers.rethink.RethinkQueryCache;
 ...
 */
public class RethinkDBDriver extends DatabaseDriver
{
	...
	public boolean tableExists( String table ) throws DatabaseException
	{
		...
		DatabaseManager.L.debug( "Got result: " + result.getClass() + " -- " + result );
