...
public class UtilDatabase
{
	...
	public static ColumnType objectToColumnType( Object obj )
	{
	...
	public static Map<String, Map<String, String>> resultToStringMap( ResultSet rs ) throws SQLException
	{
		...
		while ( next )
		{
			result.put( Integer.toString( x ), Objs.castMap( rowToMap( rs ), String.class, String.class ) );
			x++;
			next = rs.next();
		}
	...
	@Nonnull
	public static Map<String, Object> rowToMap( @Nonnull ResultSet rs ) throws SQLException
	{
	...
	public static Object sqlTypeToObject( int type )
	{
		switch ( type )
		{
			...
			case Types.LONGVARBINARY:
				return new Byte[0];
			case Types.DATE:
				return new Date( DateAndTime.epoch() );
			case Types.TIME:
				return new Time( DateAndTime.epoch() );
			case Types.TIMESTAMP:
				return new Timestamp( DateAndTime.epoch() );
			default:
				return new Object();
		}
	}
