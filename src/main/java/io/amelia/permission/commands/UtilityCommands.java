		...
		if ( args.containsKey( "type" ) && args.containsKey( "id" ) )
			switch ( args.get( "type" ) )
			{
				case "entity":
					...
					{
						entity.save();
						sender.sendMessage( EnumColor.AQUA + "Wonderful news, we successfully committed changes made to entity `" + entity.getUuid() + "`!" );
					}
					break;
				case "group":
					...
					{
						group.save();
						sender.sendMessage( EnumColor.AQUA + "Wonderful news, we successfully committed changes made to group `" + group.getUuid() + "`!" );
					}
					break;
	...
	public void reload( TerminalEntity sender, Map<String, String> args )
	{
		if ( args.containsKey( "id" ) )
		{
			...
			if ( entity == null )
			{
				...
				{
					group.reload();
					sender.sendMessage( EnumColor.AQUA + "Wonderful news, we successfully reloaded group `" + group.getUuid() + "` from backend!" );
				}
			}
			else
			{
				entity.reload();
				sender.sendMessage( EnumColor.AQUA + "Wonderful news, we successfully reloaded entity `" + entity.getUuid() + "` from backend!" );
			}
		}
		else
			try
