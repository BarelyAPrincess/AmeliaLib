...
public class EntityCommands extends PermissionBaseCommand
{
	...
	@CommandHandler( name = "pex", syntax = "entity <entity> check <permission> [ref]", permission = "permissions.manage.<entity>", description = "Checks getUserContext for <permission>" )
